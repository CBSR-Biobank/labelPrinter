...
public class ConfigurationTree {
	 ...
	 * 
	 * @param location
	 *            eg. "animal.dog.nose.hair"
	 * @param value
	 *            eg. new Rectangle(1,2,3,4)
	 ...
	 * 
	 * @param config
	 *            Any changes made to the tree will be reflected in the
	...
	public ConfigurationTree(Composite parent, int style) {
		...
		column2.setText("Horizontal");
		column2.setWidth(60);
		TreeColumn column3 = new TreeColumn(tree, SWT.CENTER);
		column3.setText("Vertical");
		column3.setWidth(60);
		TreeColumn column4 = new TreeColumn(tree, SWT.CENTER);
		column4.setText("Width");
		column4.setWidth(60);
		TreeColumn column5 = new TreeColumn(tree, SWT.CENTER);
		column5.setText("Height");
		column5.setWidth(60);
		...
		tree.addListener(SWT.MouseDown, new Listener() {
			public void handleEvent(Event event) {
				...
				for (int colIndex = 1; colIndex < 5; colIndex++) {
					...
					Rectangle rect = currentTableItem.getBounds(colIndex);
					if (rect.contains(pt)) {
	...
	private String[] rectangleToString(Rectangle r) {
		...
		buf[0] = "null";
		buf[1] = String.valueOf(r.x);
		buf[2] = String.valueOf(r.y);
		buf[3] = String.valueOf(r.width);
		buf[4] = String.valueOf(r.height);
